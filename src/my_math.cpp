...
//------------------------------------------------------------------------------
//  @brief      double myMath_sin(double rad)
//  @param      
//  Sample usage:           
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
//  @brief      float myMath_cos(double rad)
//  @param      
//  Sample usage:           
//------------------------------------------------------------------------------
...
//  Sample usage:           
//------------------------------------------------------------------------------
float myMath_normal(uint8_t x, float u, float o2)
{
    return 1.0/sqrt(o2*2*MYMATH_PI)*exp(-(u-x)*(u-x)/(2*o2));
}
